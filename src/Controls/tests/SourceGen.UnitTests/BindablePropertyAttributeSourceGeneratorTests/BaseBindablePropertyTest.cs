...
public abstract class BaseBindablePropertyTest
{
...
#error ReferenceAssemblies must be updated to current version of .NET
			...
			TestState =
			{
				...
				AdditionalReferences =
				{
					...
					MetadataReference.CreateFromFile(typeof(Microsoft.Maui.Controls.AccessModifier).Assembly.Location),
					MetadataReference.CreateFromFile(typeof(Microsoft.Maui.Controls.BindablePropertyAttribute).Assembly.Location),
					MetadataReference.CreateFromFile(typeof(Microsoft.Maui.Controls.AttachedBindablePropertyAttribute<>).Assembly.Location),
				}
			}
		};

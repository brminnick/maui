...
[Generator]
public class AttachedBindablePropertyAttributeSourceGenerator : BaseBindablePropertySourceGenerator
{
	...
	{
		var @namespace = classSymbol.ContainingNamespace.ToFQDisplayString();
		var className = classSymbol.Name;
		var classAccessibility = classSymbol.DeclaredAccessibility.ToString().ToLower(CultureInfo.InvariantCulture);
		...
		return new(classInfo, new EquatableArray<AttachedBindablePropertyModel>([..attachedBindablePropertyModels]));
	}
	...
	static AttachedBindablePropertyModel CreateAttachedBindablePropertyModel(AttributeData attributeData, INamedTypeSymbol declaringType)
	{
		...
		var defaultBindingMode = GetNamedTypeArgumentsAttributeValueForDefaultBindingMode(attributeData, "DefaultBindingMode", "(global::Microsoft.Maui.Controls.BindingMode)0");
		var validateValueMethodName = GetNamedMethodGroupArgumentsAttributeValueByNameAsString(attributeData, "ValidateValueMethodName");
		var propertyChangedMethodName = GetNamedMethodGroupArgumentsAttributeValueByNameAsString(attributeData, "PropertyChangedMethodName");
		var propertyChangingMethodName = GetNamedMethodGroupArgumentsAttributeValueByNameAsString(attributeData, "PropertyChangingMethodName");
		var coerceValueMethodName = GetNamedMethodGroupArgumentsAttributeValueByNameAsString(attributeData, "CoerceValueMethodName");
		var defaultValueCreatorMethodName = GetNamedMethodGroupArgumentsAttributeValueByNameAsString(attributeData, "DefaultValueCreatorMethodName");

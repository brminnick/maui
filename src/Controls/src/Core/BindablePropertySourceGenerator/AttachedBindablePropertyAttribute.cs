...
public sealed partial class AttachedBindablePropertyAttribute<T>(string propertyName) : global::System.Attribute where T : notnull
{
	...
	/// <summary>
	/// The access modifier applied to the generated field <see cref="Microsoft.Maui.Controls.BindableProperty"/>. The default is <see cref="AccessModifier.Public"/>.
	/// </summary>
	public AccessModifier BindablePropertyAccessibility { get; init; } = AccessModifier.Public;

	/// <summary>
	/// The access modifier applied to the generated method <c>Get{PropertyName}(BindableObject bindable)</c>. The default is <see cref="AccessModifier.Public"/>.
	/// </summary>
	public AccessModifier GetterAccessibility { get; init; } = AccessModifier.Public;

	/// <summary>
	/// The access modifier applied to the generated method <c>Set{PropertyName}(BindableObject bindable, T value)</c>. The default is <see cref="AccessModifier.Public"/>.
	/// </summary>
	public AccessModifier SetterAccessibility { get; init; } = AccessModifier.Public;
}